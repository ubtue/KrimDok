...
RUN_CMD="$JAVA -cp . $INDEX_OPTIONS -DVUFIND_LOCAL_DIR=$VUFIND_LOCAL_DIR -Duser.timezone=UTC $EXTRA_SOLRMARC_SETTINGS -jar $JAR_FILE $PROPERTIES_FILE -solrj $VUFIND_HOME/solr/vendor/dist/solrj-lib $MARC_PATH/$MARC_FILE"
